...
// ANSWER: No because the if statement is constant.
...
// Q: What is the space complexity of this function?
// ANSWER: O(n)
//taking in our numbers array, answers array and pushing squared values to answers array
//answers array is dependent on length or passed in array

// Q: Is it possible to improve this function's space complexity? If it is, write a new function below.
// ANSWER: no because even if we were to remove the numbers2 variable it would be considered an O(n) with the declaration of answers array
...
// ANSWER: Both are linear and are dependent on the length of the str
